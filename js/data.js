...
const GENERATOR_DEFS = [
  ...
  { id:"g7", name:"Σ", iconSrc:"icon/sigma.png", desc:"シグマ様が素数の世界から手助けしてくれるよ", baseCost: 17999927, growth:1.15, cps:29989, unlock:[ {type:"generatorLevel",target:"g6",value:5} ] },
];
...
const UPGRADE_DEFS = [
  ...
  { id:"click3", name:"ゲリラのように落ちてくる", iconSrc: "icon/handpop.png", desc: "全部まとめて ぱぱっと連打。クリック獲得量が4倍になるよ！", cost:4000, type:"clickMult", value:4, unlock:[ {type:"clickCount",value:700} ] },
  ...
  { id:"g1_10", name:"好きな物：うさぎグッズ", iconSrc: "icon/mimi.png", desc: "お気に入りのグッズを身に着けて、ミミちゃんの能力が3倍になるよ", cost:300, type:"targetMult", target:"g1", value:3, unlock:[ {type:"generatorLevel",target:"g1",value:10} ] },
  ...
  { id:"g2_10", name:"好きな物：ジェットコースター", iconSrc: "icon/nyami.png", desc: "スリル満点！ニャミちゃんの能力が2倍になるよ", cost:1500, type:"targetMult", target:"g2", value:2, unlock:[ {type:"generatorLevel",target:"g2",value:10} ] },
  ...
  { id:"g2_m30", name:"ミミちゃん応援団<ピッ!ピッ!", iconSrc: "icon/mimi.png", desc: "ミミちゃんからの応援でニャミちゃんの能力が2倍になるよ", cost:15000, type:"targetMult", target:"g2", value:3, unlock:[ {type:"generatorLevel",target:"g1",value:30} ] },

  { id:"g3_5", name:"大きな安全ピン", iconSrc: "icon/pin.png", desc: "見習い天使の必需品。ポエットちゃんの能力が2倍になるよ", cost:10000, type:"targetMult", target:"g3", value:2, unlock:[ {type:"generatorLevel",target:"g3",value:5} ] },
  ...
  { id:"g4_10", name:"好きな物：あまいおくすり", iconSrc: "icon/candy.png", desc: "真っ暗な夜にとけこんで、ちぇるみんの能力が2倍になるよ", cost:150000, type:"targetMult", target:"g4", value:2, unlock:[ {type:"generatorLevel",target:"g4",value:10} ] },
  ...
  { id:"g6_10", name:"好きな物：コスプレ衣装", iconSrc: "icon/scissors.png", desc: "こっそり着替えてニアちゃんの能力が3倍になるよ", cost:15000000, type:"targetMult", target:"g6", value:3, unlock:[ {type:"generatorLevel",target:"g6",value:10} ] },
  { id:"g6_20", name:"暗くて静かな部屋", iconSrc: "icon/room.png", desc: "落ち着く環境でニアちゃんの能力が6倍になるよ", cost:90000000, type:"targetMult", target:"g6", value:6, unlock:[ {type:"generatorLevel",target:"g6",value:20} ] },

  { id:"g7_7", name:"好きな物：ネクタル", iconSrc: "icon/nectar.png", desc: "神々のためのお酒。シグマ様の能力が3倍になるよ", cost:150000001, type:"targetMult", target:"g7", value:3, unlock:[ {type:"generatorLevel",target:"g7",value:7} ] },
...
const ACHIEVEMENT_DEFS = [
  ...
  { id: "click_100", name: "100コンボ", iconSrc: "icon/click100.png", desc: "ポップ君を100回クリックする", unlock: [{ type: "clickCount", value: 100 }] },
  { id: "click_1025", name: "準辛ゲージ", iconSrc: "icon/kara1.png", desc: "ポップ君を1025回クリックする", unlock: [{ type: "clickCount", value: 1025 }] },
  { id: "click_1537", name: "辛ゲージ", iconSrc: "icon/kara2.png", desc: "ポップ君を1537回クリックする", unlock: [{ type: "clickCount", value: 1537 }] },
  { id: "earn_1000", name: "ポップ君大集合", iconSrc: "icon/minipop.png", desc: "累計で1000ノーツを獲得する", unlock: [{ type: "totalNotesCount", value: 1000 }] },
  { id: "earn_6573", name: "トイサイダー村", iconSrc: "icon/toy.png", desc: "累計で6573ノーツを獲得する", unlock: [{ type: "totalNotesCount", value: 6573 }] },
  { id: "earn_50all", name: "Lv50全ノーツ相当", iconSrc: "icon/lv50.png", desc: "(THX 4まで全26譜面)累計で46115ノーツを獲得する", unlock: [{ type: "totalNotesCount", value: 46115 }] },
  { id: "earn_pop1", name: "ポップン初代稼働日", iconSrc: "icon/minipop.png", desc: "累計で19980928ノーツを獲得する", unlock: [{ type: "totalNotesCount", value: 19980928 }] },
